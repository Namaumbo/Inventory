<template>
    <form class="row g-3">
        ...
        <div class="col-md-1">
            <label for="cost" class="form-label" ><i class="bi bi-archive"></i>STOCK</label>
       ...
       <div class="col-md-1">
        ...
        <div class="col-12">
            <button type="submit"
                ...
                &nbspAdd product&nbsp&nbsp&nbsp</button>
            <button type="submit" class="btn btn-secondary" onclick="save">
